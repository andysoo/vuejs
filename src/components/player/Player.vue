<template>
  <div class="player-page">
    <h1 class="caption">
      <router-link :to="{name:'List'}">我的私人音乐坊 &gt;</router-link>
    </h1>
    <div class="mt20 row">
        ...
        <div class="row mt20">
          ...
          <div class="volume-container">
            ...
            <div class="volume-wrapper">
              <ProgressBer :value="volume*100" @changeProgress="CHANGE_VOLUME"></ProgressBer>
            </div>
          </div>
        </div>
        <div style="height: 10px; line-height: 10px;">
          <ProgressBer :value="currentPercentAbsoulte" @changeProgress="CHANGE_PROGRESS"></ProgressBer>
        </div>
        <div class="mt35 row">
          <div>
            <i class="icon prev"></i>
...
<script>
import ProgressBer from '../progress/Progress.jsx'
